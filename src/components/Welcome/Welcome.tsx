  ...
  return (
    <div className={styles.Welcome}>
      ...
      <p className={styles.welcomeText}>
        Welcome to Ekia's shopping list. Here you will be able to create a todo list with all the furniture you want to buy. <br/><br/>
        To get started press the Add new item button and a popup will ask you the name and price of the item you want to add. You can also add an image after the item is added by touching the camera icon.</p>
